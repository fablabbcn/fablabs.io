...
ready = ->
  ...
  if $('body').hasClass 'c-labs a-show'
    ...
    L.tileLayer('https://{s}.tile.cloudmade.com/d8b794cdcd1e4e37bd83addfd40b7c68/110755/256/{z}/{x}/{y}.png', {}).addTo(labmap)
    icon = L.icon({
  ...
  if $('body').hasClass 'c-labs a-map'
    ...
    L.tileLayer('https://{s}.tile.cloudmade.com/384aceabcd0942189d0e93cf0e98cd31/90734/256/{z}/{x}/{y}.png').addTo(map)
