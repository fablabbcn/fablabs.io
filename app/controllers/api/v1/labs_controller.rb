class Api::V1::LabsController < Api::V0::ApiController
  ...
  def index
    @labs = Lab.with_approved_state.includes(:links, :employees, :machines, :projects).eager_load(projects: :documents).order(:slug).paginate(:page => params[:page], :per_page => 20)
